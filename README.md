  ...
  final eu = InformacoesPessoais(
    ...
    projetos_relevantes: <Projeto>[
      Projeto(
        ...
        url: Uri.https('github.com', 'guilhermecarv32/xplearn'),
      ),
      Projeto(
        'Dança+',
        descricao: 'Aplicativo gamificado com foco no engajamento de alunos',
        stack: ['Flutter', 'Firebase'],
        url: Uri.https('github.com', 'guilhermecarv32/danca-mais'),
      ),
      Projeto(
        'Dani e Ellas',
        descricao: 'Sistema de loja usado em negócio real',
        stack: ['Electron', 'Firebase'],
        url: Uri.https('github.com', 'guilhermecarv32/dani-e-ellas'),
      ),
      Projeto(
        'Expenses App',
        descricao: 'App mobile de controle financeiro',
        stack: ['Flutter'],
        url: Uri.https('github.com', 'guilhermecarv32/expenses-app'),
      ),
    ],
